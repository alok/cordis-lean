...
rejects required opaque rows. It intentionally stops before local session replay: dropping a
physical row leaves source sequence numbers with a gap, so renumbering and semantic normalization
