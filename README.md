...
branch retains its pre-round decision and empty accepted prefix. Blocked-read interruption,
fairness, cleanup, reconnect, and deployed async retry/cancellation equivalence remain external.
...
| `Cordis.DeepSeekAsyncStreamRetryCancellation`           | Cooperative race over retry-aware streamed children; the winner retains its dependent indexed retry trace, while a cancellation-first fixture retains the pre-round decision and empty accepted prefix. Blocked-read interruption, fairness, cleanup, reconnect, and deployed async retry/cancellation equivalence remain external.                                                                 |
...
| `Cordis.DeepSeekAsyncStreamRetryCancellation`           | Cooperative `ContextAsync.race` over retry-aware streamed jobs; each result keeps its dependent retry trace/final endpoint, and the cancellation-first fixture exposes a typed round/reason stop with zero accepted rounds. Blocked-read interruption, fairness, cleanup, reconnect, and deployed async equivalence remain external.                                                                |
