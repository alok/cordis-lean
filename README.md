...
dependent assignments remain exact.
...
| `Cordis.GlobalRuleRelatedDetailedReplay`                        | Adds constructor-sensitive `detailedRule` preservation to exact `RuleRelated` matches and projects the resulting assigned replay to the birth-erased paper trace package; it does not conflate L-DivertAbort with L-DivertLand.                                                                                                                                                                                                                                                                                                                                |
