...
`Cordis.DeepSeekSessionRunner` composes the text, one-tool, and mixed validators
...
| `Cordis.DeepSeekSessionRunner`                      | Pure composition of accepted text/one-tool/mixed responses into an append-only session runner with exact sequence, message-order, and tool-call-count invariants.                                                                                                                                                        |
