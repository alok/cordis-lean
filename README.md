...
activation/orchestration rewrite, exposing the concrete terminal ledgers
`[O-Insert, O-Insert, L-Begin]` and actors `[0, 1, 0]`. This is a proof-carrying rewrite-chain
