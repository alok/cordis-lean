...
backward replay, and positional keep/drop replay. `Cordis.GlobalPaperTraceNormalization` composes a finite connected list of
...
| `Cordis.GlobalPaperTraceSimulation`                     | Birth-erased finite forward and backward trace replay with assigned-step transport, endpoint well-formedness, final relation, and exact rule/actor projections; lifecycle matching remains explicit.                                                                                                                                                                                                |
