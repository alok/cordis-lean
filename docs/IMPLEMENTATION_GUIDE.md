...
normalization, episode programs, and the paper's literal total/quotient Lemma 71 remain outside the
result. `GlobalDeletion` now constructs positional relation-indexed keep/drop replay and exact
