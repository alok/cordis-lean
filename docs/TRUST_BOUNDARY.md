...
| `GlobalPaperTraceConfluence`                                                                                                                                                                              | Provides a generic decreasing/local-diamond Newman kernel: `global_join` joins any two finite paths, and `NormalForm.endpoint_eq` proves uniqueness of irreducible endpoints; a Boolean two-branch witness exercises both reduction orders.                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Conditional metatheory only. Local diamonds, a decreasing measure, and a normal-form strategy remain supplied; no CORDIS-specific canonical form, Theorem 73, or global confluence is derived.                                                                                                                                                        |
