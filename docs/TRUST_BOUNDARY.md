...
the text-only SSE subset. `executeStreamingTextAndAppend` retains the mode-indexed streaming
plan, strict process/SSE frames, finished rich response, and exact schema-indexed append endpoint.
Richer reasoning/tool/mixed/multi-call streams, malformed/incomplete bodies, blocked-read
interruption, live networking, credentials, provider behavior, persistence, and deployed
...
| `DeepSeekSessionRequestStreaming`                                                                                                                                                                         | The indexed text-only stream bridge retains a proved streaming `RequestPlan`, strict process/SSE frames, finished rich response, and exact schema-indexed append endpoint.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Richer stream kinds, malformed/incomplete bodies, blocked reads, live/provider behavior, persistence, and deployed equivalence remain external.                                                                                                                                                                                                        |
