...
dependent response certificate. Optional DeepSeek controls are caller policy. The module does not
prove parser-backed schema validity, provider obedience, credentials, remote transport success, or
deployed equivalence.
