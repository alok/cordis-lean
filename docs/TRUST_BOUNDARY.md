...
| `GlobalRuleRelatedDetailedReplay`                                                                                                                                                                          | Adds a constructor-sensitive `detailedRule` obligation to exact `RuleRelated` matches and packages the resulting all-keep trace as a birth-erased paper replay while retaining exact shadow steps and assignments.                                                                                                                                                                                                                                   | Detailed-tag exact replay projection.                                                                                                                                                                                                                                                      | The detailed-tag field is not inferred from coarse global rule equality; no lifecycle simulation, allocator erasure, episode deletion, Lemma 72, or Theorem 73 is claimed.                                                               |
