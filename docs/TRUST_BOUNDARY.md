...
| `GlobalRuleRelatedDetailedReplay`                                                                                                                                                                          | Adds a constructor-sensitive `detailedRule` obligation to exact `RuleRelated` matches and packages both forward and backward all-keep traces as birth-erased paper replays while retaining exact shadow steps and assignments.                                                                                                                                                                                                                                   | Detailed-tag exact replay projection in both orientations.                                                                                                                                                                                                                                                      | The detailed-tag field is not inferred from coarse global rule equality; no lifecycle simulation, allocator erasure, episode deletion, Lemma 72, or Theorem 73 is claimed.                                                               |
