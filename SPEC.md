...
| `Cordis.DeepSeekSessionRequestStreaming`                         | Indexed streaming continuation for the strict text-only SSE subset: `executeStreamingTextAndAppend` retains the mode-indexed streaming plan, process/SSE wire frames, finished rich response, and exact `ExtensionRunner` endpoint. Reasoning, tool, mixed, multi-call, unsupported-finish, malformed, and incomplete streams remain typed rejections; injected process configuration and local semantics do not imply live provider or deployed Harness behavior.                                                                                                                                                                                                                                                                                                                                                  |
