...
| `Cordis.DeepSeekHarnessEventIgnorableProjection`           | Archive-side projection for the current envelope's explicit `ignorable: true` marker: positional keep/drop decisions drop only opaque ignorable rows, retain supported wire certificates and source positions, and reject required opaque rows. Dropping a physical row leaves sequence-number normalization and local session replay as explicit later obligations.                                                                                                                                                                                                                                                                                                                                                                                                                                                |
