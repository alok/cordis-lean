...
| `Cordis.DeepSeekSchemaHarness`             | Carries a successful schema-aware execution into the existing `DeepSeekHarness.ExecutedTool` and exact session append surface without re-executing it; provider certificates remain nested, and message/next-sequence/protocol-projection theorems are reused.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
