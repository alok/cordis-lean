...
remains a local finite adapter: process identity, sandboxing, authentication, exactly-once effects,
cleanup, persistence, provider obedience, and deployed Harness equivalence remain external.
