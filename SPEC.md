...
| `Cordis.DeepSeekHarnessPersistenceStreamBytePrefixTimeout` | Composes memory-backed validated restore with the timed byte-prefix process adapter: the fixture retains archive `nextSeq = 8`, one accepted streamed tool round, final `nextSeq = 10`, model `0`, and explicit fuel exhaustion together with the restored-session equality. Durable media, crash recovery, blocked-read interruption, provider/process authenticity, cleanup, external effects, and deployed Harness equivalence remain external.                                                                                                                                                                                                                                                                                                                                                                  |
