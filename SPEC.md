...
cancellation-first child retains the pre-round decision and empty accepted prefix. Blocked-read
...
| `Cordis.DeepSeekAsyncStreamRetryCancellation`   | Cooperative race over retry-aware streamed children; the winner retains its dependent indexed retry trace/final endpoint, while a cancellation-first fixture retains the pre-round decision and empty accepted prefix. Blocked-read interruption, fairness, cleanup, reconnect, and deployed retry/cancellation equivalence remain external.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
